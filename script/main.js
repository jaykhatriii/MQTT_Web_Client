...
function connection_stat(){
    ...
    if(!client.connected) {
        ...
        document.getElementsByClassName('sub_div')[0].style.backgroundColor ="#FEFCF3";
        document.getElementsByClassName('sub_debug')[0].style.backgroundColor ="#FEFCF3";
        document.getElementsByClassName('pub_div')[0].style.backgroundColor ="#FEFCF3";
    }
}
...
conf('ws://test.mosquitto.org:8081','');
